...
return [
    ...
    'section_labels' => [
        'top_reviews' => 'أفضل :section من التقييمات',
        'featured' => ':section مميزة',
        'new_stores' => ':section جديدة',
        'all' => 'كل :section',
    ],
    'promotion_type' => [
        'delivery' => 'توصيل',
    ...
    'promotion_sub_type' => [
        'free_delivery' => 'توصيل مجاني',
        'discount_delivery' => 'توصيل مخفضة',
        'fixed_delivery' => 'توصيل ثابت',
        'fixed_price' => 'سعر ثابت',
        'percentage_discount' => 'خصم في المئة',
        'first_order' => 'الطلب الأول',
        'bundle' => 'مجموعة',
        'buy_one_get_one' => 'شراء واحد وحصل على واحد',
    ],
    'promotion' => [
        'type' => 'النوع',
        ...
        'fixed_delivery_price' => 'سعر التوصيل الثابت',
        ...
        'target_id' => 'معرف الاستهداف',
        'is_excluded' => 'مستبعد',
        'fixed_prices' => 'الأسعار الثابتة',
    ...
    'message' => [
        ...
        'promotion_not_found' => 'الترقية غير موجودة',
        'promotion_not_applicable' => 'الترقية غير قابلة للتطبيق',
        'promotion_applied' => 'تم تطبيق الترقية بنجاح',
    ],
];
