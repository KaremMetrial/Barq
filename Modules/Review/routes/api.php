...
Route::prefix('v1/admin')->middleware(['auth:sanctum', 'ability:admin,vendor,user'])->group(function () {
    Route::apiResource('reviews', ReviewController::class)->names('admin.review');

    Route::apiResource('rating-keys', RatingKeyController::class)->names('admin.rating-keys');
});
