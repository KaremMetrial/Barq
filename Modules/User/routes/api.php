...
Route::prefix('v1')->group(function () {
    Route::get('admin/users/stats', [UserController::class, 'stats'])->name('admin.users.stats');
    Route::get('admin/users/{id}/stats', [UserController::class, 'statsForUser'])->name('admin.user.stats');
